...
def menu():
	...
	print(" "+p+"["+K+"*"+P+"] ID   : "+U+id)
        print(" "+p+"["+K+"*"+P+"]ــــــــــــــــــــــــــــــــــــ")
        print(" "+p+"["+K+"*"+P+"] IP    : "+H+ip)
	print(" "+p+"["+K+"*"+P+"] Status: "+H+"PREMIUM "+P+"PANTEK:>")
	print(" "+p+"["+K+"*"+P+"]ــــــــــــــــــــــــــــــــــــ ")
	print
	print("      [ SELAMAT DATANG PANTEK "+H+"DMBF"+P+":) ]")
	print
...
def public():
	...
	ask = raw_input("\n \033[0;97m[\033[0;93m?\033[0;97m] Pake Password Manual Atau Tidak Njing? Y/t : ")
	if ask == "Y" or ask == "y":
		manual()
...
def cek_ingfo():
    ...
    try:
#	print(p+"Silahkan Ketik : "+i+"User"+p+"Cara Ambil ID Facebook !!");time.sleep(2)
